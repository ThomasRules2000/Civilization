...
public class HexType
{
    ...
    public static Dictionary<typeKeys, HexType> types = new Dictionary<typeKeys, HexType> //Todo - add more tile types
    {
        ...
        { typeKeys.ocean,   new HexType(Color.blue, new Color(0, 0, 0.8f),  1, true)  },
        ...
        { typeKeys.coast,   new HexType(new Color(0.298f, 0.298f, 1), new Color(0.238f, 0.238f, 0.8f), 1, true)  },
